// lists clone, to get a list of all user fleets
...
function FleetList({ type }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`https://localhost:8080/api/fleets/tpag2/${type}?page=${currentPage - 1}&size=${itemsPerPage}`);
    ...
    const handleDelete = async(e) => {
        ...
        try {
            ...
            //     },
            // });
            const fetchResult = await fetch("https://localhost:8080/api/fleets/delbulk", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    return (
        ...
        <div className="itemlists-container">
            ...
            <div className="itemlists-table">
                                ...
                                <tr key={i} className={isSelected ? 'row-selected' : ''}>
                                    ...
                                    <td>
                                        <div className="opt-area">
                                            <div className="edit" onClick={() => navigate(`/MyAccount/fleets/${row[Object.keys(row)[0]]}`)}>
                                                View and Edit
                                                {/* <img src={edit}></img> */}
                                            </div>
                                        </div>
                ...
                <div className="under-btn" onClick={() => navigate("/vessels")}>
                    Create New Fleet
                </div>
            </div>
